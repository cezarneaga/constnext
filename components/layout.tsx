...
export default function Layout({ preview, children }: { preview: boolean; children: ReactElement | ReactElement[] }) {
  ...
  const boxShadow = useColorModeValue('0 0 7px rgba(0, 0, 0, 0.1)', '0 0 7px rgba(22, 31, 41, 0.9)')
  return (
    <Grid gap='0' templateRows='auto auto 110px' templateAreas="'navi' 'main' 'footer'">
      <Box
        as='nav'
        gridArea='navi'
        pos='sticky'
