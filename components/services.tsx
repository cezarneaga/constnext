...
import { Code as CodeIcon, Compass, Server } from "react-feather";
      ...
      <Box width="100%" maxW="1280px" mx="auto" py="8">
        ...
        <Box maxW={["100%", "80%", "68%"]} mx="auto" mt="4">
          <Heading
            ...
            fontWeight="700"
          >
            We spend most working days exploring the latest technologies in web development, working
            and learning together with an{" "}
            <Link
            ...
            of software developers. We give back by building open source projects for social
        ...
        >
          ...
          >
            ...
            <Text fontSize={["sm", "sm", "sm", "lg", "lg"]}>
              We grew wiser along with the web. Mistakes were replaced by learnings. If you are in
              the process of planning your web strategy we can share our{" "}
              <Link
                color="brand.500"
                fontWeight="600"
          ...
          >
            ...
            <Text fontSize={["sm", "sm", "sm", "lg", "lg"]}>
              Small website or a community platform? We love simple, effective designs and of
              course, offering a great content management experience for you.
            </Text>
            <Code
              borderWidth="1px"
              width="100%"
          ...
          >
            ...
            <Text fontSize={["sm", "sm", "sm", "lg", "lg"]}>
              50% of visitors expect pages to load in 2 seconds or less. I offer bespoke server
              configurations and management to deliver this and more.
            </Text>
            <Code
              borderWidth="1px"
              width="100%"
