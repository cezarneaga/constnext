      ...
      <Box width='100%' maxW='1280px' mx='auto' py='8'>
        ...
        <Box maxW={['100%', '80%', '68%']} mx='auto' mt='4'>
          <Heading as='h3' textAlign='center' color={textColor} lineHeight='1.5em' fontSize='xl' fontWeight='700'>
            We spend most working days exploring the latest technologies in web development, working and learning together with an{' '}
            <Link href='https://www.meetup.com/ReactVienna/' isExternal color='brand.500' title='React Vienna'>
              amazing community
            </Link>{' '}
            of software developers. We give back by building open source projects for social entrepreneurs and civil society.
          </Heading>
        </Box>
        <Grid templateColumns={['1fr', '1fr', 'repeat(3, minmax(220px, 1fr))']} gap={6} maxWidth='1280px' my='8' mx='auto'>
          <Flex flexDirection='column' alignItems='center' p='4' borderWidth='1px' borderRadius='md'>
            ...
            <Text fontSize={['sm', 'sm', 'sm', 'lg', 'lg']}>
              We grew wiser along with the web. Mistakes were replaced by learnings. If you are in the process of planning your
              web strategy we can share our{' '}
              <Link
                color='brand.500'
                fontWeight='600'
            ...
            <Code borderWidth='1px' width='100%' p='2' mt='4' fontSize={['sm', 'sm', 'xs', 'sm', 'sm']}>
          ...
          <Flex flexDirection='column' alignItems='center' p='4' borderWidth='1px' borderRadius='md'>
            ...
            <Text fontSize={['sm', 'sm', 'sm', 'lg', 'lg']}>
              Small website or a community platform? We love simple, effective designs and of course, offering a great content
          ...
          <Flex flexDirection='column' alignItems='center' p='4' borderWidth='1px' borderRadius='md'>
            ...
            <Text fontSize={['sm', 'sm', 'sm', 'lg', 'lg']}>
              50% of visitors expect pages to load in 2 seconds or less. I offer bespoke server configurations and management to
