  ...
  return (
    <Layout preview={preview}>
      ...
      <Box
        ...
        height={['calc(79px * 2)', 'calc(79px * 2)', '200px', '240px', '240px']}>
        <Box width={'100%'} height='100%' py='12' pr='4' pl={['4', '4', '4', '4', 'calc(((100% - 1280px) / 2) + 1em)']}>
          <Heading textTransform='uppercase' fontSize='42px' lineHeight='1.5em' color={headingColor}>
            Projects
          </Heading>
          <Box display='block' backgroundColor={headingColor} width='100px' height='7px' />
        </Box>
      </Box>
