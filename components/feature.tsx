...
import type { Feature } from "lib/contentTypes";
import Image from "next/image";

export function FeatureView({ imageLeft, image, heading, description, bottomSpacer }: Feature) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Heading fontSize={["lg", "lg", "md", "lg"]} color={color} lineHeight="base">
          {description}
        </Heading>
      </Flex>
